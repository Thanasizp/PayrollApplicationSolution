    ...
    public partial class RegisterUser : Form
    {
        ...
        private bool isRegisterControlsValid()
        {
            ...
            else
            {
                ...
                {
                    MessageBox.Show("Both passwords do not match please, try again!", "Data Enter Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    txtConfirmPassword.Focus();
                    return false;
                }
            }
            ...
            // If all the validations are successed than return true
            return true;
        }
        ...
        private void UserData()
        {
            ...
            objUser.UserName = txtDescription.Text;
        }
        ...
        private void btnRegisterUser_Click(object sender, EventArgs e)
        {
            ...
            //string name, password, userRole, description;

            //name = txtRegisterUserName.Text;
            //password = txtRegisterPassword.Text;
            //userRole = txtRoles.Text;
            //description = txtDescription.Text;

            //Users objUsers = new Users();

            ////Users.userName = name;  //Static members access via class type "Users"
            //objUsers.userName = name;
            //objUsers.password = password;
            //objUsers.role = userRole;
            //objUsers.description = description;
            ////userRole = Users.role;  //Static members access via class type "Users"
            ////description = objUsers.description;

            //MessageBox.Show(string.Format("UserName : {0}\n Password : {1}\n Role : {2}\n Role Description : {3}\n", name, password, userRole, description));

            //Users objUsers = new Users(name, password, userRole, description);
